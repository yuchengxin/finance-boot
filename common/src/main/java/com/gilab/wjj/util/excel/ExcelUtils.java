...
//        font.setBoldweight(Font.BOLDWEIGHT_BOLD);
                ...
                if (field.getName().equals(key)) {
                    ...
                    if (field.getType().equals(Date.class)) {
                        ...
                        if (o.getClass().equals(Long.class)) {
                            ...
                            String[] intStr = (o.toString()).split("\\.");
                            field.set(e, Long.parseLong(intStr[0]));
                        }
                        ...
                        if (o.getClass().equals(Integer.class)) {
                            ...
                            String[] intStr = (o.toString()).split("\\.");
                            if (bool) {
                                field.set(e, map.get(intStr) != null ? Integer.parseInt(map.get(intStr)) : Integer.parseInt(intStr[0]));
                            } else {
                                field.set(e, Integer.parseInt(intStr[0]));
                            }
    ...
    private static Field[] getClassFieldsAndSuperClassFields(Class Entity) {
        List<Field> fieldList = new ArrayList<>();
        while (Entity != null && !Entity.getName().toLowerCase().equals("java.lang.object")) {//当父类为null的时候说明到达了最上层的父类(Object类).
            fieldList.addAll(Arrays.asList(Entity.getDeclaredFields()));
            Entity = Entity.getSuperclass(); //得到父类,然后赋给自己
        }
