 ...
 * Change:
 */
public class AddedLedger implements Entity {
    private long id;
    ...
    public AddedLedger(long id, long contractId, long merchantId, String calFormula, long planPayDate,
    ...
    public static class Builder{
        ...
        public AddedLedger build(){
            return new AddedLedger(id, contractId, merchantId, calFormula, planPayDate, planPayCount, actualPayDate, actualPayCount);
        }
    }
}
